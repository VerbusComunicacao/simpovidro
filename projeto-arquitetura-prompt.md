# Prompt de Contexto do Projeto (Padrão MVP)

Este documento serve como um guia de contexto para assistentes de IA que trabalharem neste projeto. Ele descreve os padrões arquiteturais e convenções adotadas.
